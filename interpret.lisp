...
(defun normal_parameter_name (p) 
  (if (is_parameter_with_default_ p) 
      (return (1st p)) 
    (return p)))
(let* ((__gensym-let-value-6 (__defstruct "function" "name" "env" "parameters" "varargs_name"
                                          "keysargs_name" "nokeys" "block_name" "body"))) 
  (def function (aref __gensym-let-value-6 0)) 
  (def is_function (aref __gensym-let-value-6 1)) 
  (def function_name (aref (aref __gensym-let-value-6 2) 0)) 
  (def function_env (aref (aref __gensym-let-value-6 2) 1)) 
  (def function_parameters (aref (aref __gensym-let-value-6 2) 2)) 
  (def function_varargs_name (aref (aref __gensym-let-value-6 2) 3)) 
  (def function_keysargs_name (aref (aref __gensym-let-value-6 2) 4)) 
  (def function_nokeys (aref (aref __gensym-let-value-6 2) 5)) 
  (def function_block_name (aref (aref __gensym-let-value-6 2) 6)) 
  (def function_body (aref (aref __gensym-let-value-6 2) 7)) 
  (def function_set_name (aref (aref __gensym-let-value-6 3) 0)) 
  (set _ (aref (aref __gensym-let-value-6 3) 1)) 
  (set _ (aref (aref __gensym-let-value-6 3) 2)) 
  (set _ (aref (aref __gensym-let-value-6 3) 3)) 
  (set _ (aref (aref __gensym-let-value-6 3) 4)) 
  (set _ (aref (aref __gensym-let-value-6 3) 5)) 
  (set _ (aref (aref __gensym-let-value-6 3) 6)) 
  (set _ (aref (aref __gensym-let-value-6 3) 7)))
